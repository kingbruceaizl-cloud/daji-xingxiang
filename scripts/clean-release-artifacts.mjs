...
const releaseArtifactPattern =
  /^daji-xingxiang-(?:source-[a-f0-9]+\.zip(?:\.sha256)?|release-[a-f0-9]+\.json|env-handoff\.md|github-handoff\.md|launch-runbook\.md|launch-summary\.md|model-handoff\.md|supabase-init\.sql|supabase-verify\.sql|vercel-env-template\.env|vercel-handoff\.md)$/;
