...
const lines = [
  ...
  "```",
  "",
  "- [ ] 打开 GitHub Actions，确认 `大吉形象发布验证` 通过。",
  "- [ ] 手动运行 `大吉形象源码包交付`，确认附件 `daji-xingxiang-source-package` 可下载。",
  "",
  "记录：",
  "",
  "- GitHub 仓库地址：`待填写`",
  ...
  "## 5. AI 模型通道",
  "",
  "- [ ] 第一阶段优先配置 `KIE_API_KEY`。",
  "- [ ] 配置 `KIE_CALLBACK_SECRET`，并与 KIE 回调配置保持一致。",
  "- [ ] 在 KIE 控制台或创建任务参数中确认回调地址：",
  "",
  "```text",
  "https://你的域名/api/provider-callback/kie",
  "```",
  "",
  "- [ ] 使用 `gpt-image-2-text-to-image` 创建一次真实生图任务。",
  "- [ ] 使用 `gpt-image-2-image-to-image` 创建一次真实图生图任务。",
